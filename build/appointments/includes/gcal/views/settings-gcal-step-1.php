<?php wp_enqueue_script( 'app-gcal-slider', appointments_plugin_url() . 'admin/js/unslider/js/unslider-min.js', array( 'jquery' ), false, true ); ?>
<?php wp_enqueue_script( 'app-gcal', appointments_plugin_url() . 'admin/js/admin-gcal.js', array( 'app-gcal-slider' ), false, true ); ?>
<?php wp_enqueue_style( 'app-gcal-slider', appointments_plugin_url() . 'admin/js/unslider/css/unslider.css', array(), false ); ?>
