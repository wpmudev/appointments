 ...
 * @author Google, Inc.
 */
class Appointments_Google_Service_AppState extends Appointments_Google_Service
{
  ...
  public function __construct(Appointments_Google_Client $client)
  {
    ...
    $this->states = new Appointments_Google_Service_AppState_States_Resource(
        $this,
        $this->serviceName,
        'states',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appstateService = new Appointments_Google_Service_AppState(...);
 *   $states = $appstateService->states;
 *  </code>
 */
class Appointments_Google_Service_AppState_States_Resource extends Appointments_Google_Service_Resource
{
   ...
   * @return Appointments_Google_Service_AppState_WriteResult
   */
  public function clear($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('clear', array($params), "Appointments_Google_Service_AppState_WriteResult");
  }
   ...
   * @param int $stateKey The key for the data to be retrieved.
   * @param array $optParams Optional parameters.
   * @return Appointments_Google_Service_AppState_GetResponse
   */
  public function get($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Appointments_Google_Service_AppState_GetResponse");
  }
   ...
   * the version number
   * @return Appointments_Google_Service_AppState_ListResponse
   */
  public function listStates($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Appointments_Google_Service_AppState_ListResponse");
  }
   ...
   *
   * @param int $stateKey The key for the data to be retrieved.
   * @param Appointments_Google_UpdateRequest $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Appointments_Google_Service_AppState_WriteResult
   */
  public function update($stateKey, Appointments_Google_Service_AppState_UpdateRequest $postBody, $optParams = array())
  {
    $params = array('stateKey' => $stateKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Appointments_Google_Service_AppState_WriteResult");
  }
}
...
class Appointments_Google_Service_AppState_GetResponse extends Appointments_Google_Model
{
...
class Appointments_Google_Service_AppState_ListResponse extends Appointments_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Appointments_Google_Service_AppState_GetResponse';
...
class Appointments_Google_Service_AppState_UpdateRequest extends Appointments_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $data;
...
class Appointments_Google_Service_AppState_WriteResult extends Appointments_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $currentStateVersion;
