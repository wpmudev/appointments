 ...
 * @author Google, Inc.
 */
class Appointments_Google_Service_Audit extends Appointments_Google_Service
{
  ...
  public function __construct(Appointments_Google_Client $client)
  {
    ...
    $this->activities = new Appointments_Google_Service_Audit_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $auditService = new Appointments_Google_Service_Audit(...);
 *   $activities = $auditService->activities;
 *  </code>
 */
class Appointments_Google_Service_Audit_Activities_Resource extends Appointments_Google_Service_Resource
{
   ...
   * @return Appointments_Google_Service_Audit_Activities
   */
  public function listActivities($customerId, $applicationId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "Appointments_Google_Service_Audit_Activities");
  }
}
...
class Appointments_Google_Service_Audit_Activities extends Appointments_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Appointments_Google_Service_Audit_Activity';
...
class Appointments_Google_Service_Audit_Activity extends Appointments_Google_Collection
{
  protected $collection_key = 'events';
  protected $internal_gapi_mappings = array(
  );
  protected $actorType = 'Appointments_Google_Service_Audit_ActivityActor';
  protected $actorDataType = '';
  protected $eventsType = 'Appointments_Google_Service_Audit_ActivityEvents';
  protected $eventsDataType = 'array';
  protected $idType = 'Appointments_Google_Service_Audit_ActivityId';
  ...
  public function setActor(Appointments_Google_Service_Audit_ActivityActor $actor)
  {
    $this->actor = $actor;
  }
  ...
  public function setId(Appointments_Google_Service_Audit_ActivityId $id)
  {
    $this->id = $id;
  }
...
class Appointments_Google_Service_Audit_ActivityActor extends Appointments_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Appointments_Google_Service_Audit_ActivityEvents extends Appointments_Google_Collection
{
  ...
  public $eventType;
  public $name;
  protected $parametersType = 'Appointments_Google_Service_Audit_ActivityEventsParameters';
...
class Appointments_Google_Service_Audit_ActivityEventsParameters extends Appointments_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class Appointments_Google_Service_Audit_ActivityId extends Appointments_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $applicationId;
