	...
	function render_tab() {
		...
		<br />
			...
			<div class="postbox">
				...
				<br />
				<?php _e( '<b>Note for Google Business Account users:</b> GCal API usage is not free of charge for business accounts. You should contact Google Sales department first to make it available.', 'appointments') ?> 
	...
	function import_and_update_events( $worker_id=0 ) {
		...
		$events = $this->service->events->listEvents( $this->get_selected_calendar( $worker_id ), 
			apply_filters( 'app_gcal_args',
				...
				'maxResults'	=> apply_filters( 'app_gcal_max_results', 500 ),
